    ...
    <section className="py-20 md:py-28 relative overflow-hidden text-deep-black bg-gradient-to-br from-white via-metallic-white to-gray-200 rounded-[40px] md:rounded-[60px] mx-4 md:mx-10 shadow-[0_0_80px_rgba(255,255,255,0.08)] z-20 my-8">
      ...
      <div className="section-container relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="mt-8 text-center relative z-20">
          <a
            href="https://search.google.com/local/writereview?placeid=ChIJISLvbr78Hw0RPN2bTir59tk"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-white hover:bg-gold text-deep-black hover:text-white border border-gold/40 px-8 py-3.5 rounded-full font-bold text-xs uppercase tracking-widest shadow-md hover:shadow-xl transition-all duration-300 group"
          >
