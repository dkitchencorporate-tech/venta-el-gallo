      ...
      {isBookingOpen && (
        ...
        >
          ...
          <motion.div 
            ...
            className="relative w-full max-w-6xl h-full md:h-[85vh] md:max-h-[800px] bg-deep-black md:rounded-[2.5rem] shadow-[0_50px_100px_rgba(0,0,0,0.8)] border-0 md:border border-gold/30 overflow-hidden flex flex-col md:flex-row z-10"
