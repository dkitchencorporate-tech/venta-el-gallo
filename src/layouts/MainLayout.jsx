               ...
               <li className="flex items-start gap-4">
                ...
                <li className="flex flex-col gap-2">
                  <div className="flex items-center gap-3">
                    ...
                    <a href="tel:+34858950315" className="text-sm font-light hover:text-gold transition-colors">+34 858 95 03 15 <span className="text-[10px] text-gray-400 uppercase ml-1">(Fijo)</span></a>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-[#25D366] shrink-0" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://wa.me/34640147985" target="_blank" rel="noopener noreferrer" className="text-sm font-light hover:text-[#25D366] transition-colors">+34 640 14 79 85 <span className="text-[10px] text-[#25D366] uppercase ml-1">(WhatsApp)</span></a>
                  </div>
                </li>
